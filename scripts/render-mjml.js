 ...
 * automatically; this script loads everything in the right order, then renders one or more
 * MJML files.
 */

const plugins = [require("mjml-bullet-list/lib/MjList"), require("mjml-bullet-list/lib/MjLi")];

const fs = require("fs");
const path = require("path");
const mjmlCoreModule = require("mjml-core");
const mjmlValidator = require("mjml-validator");
const mjmlPreset = require("mjml-preset-core");

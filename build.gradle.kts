...
plugins {
  ...
  id("dev.monosoul.jooq-docker") version "8.0.11"
...
dependencies {
  ...
  implementation("ch.qos.logback.access:logback-access-tomcat:2.0.9")
  ...
  implementation("org.jobrunr:jobrunr-spring-boot-3-starter:8.4.1")

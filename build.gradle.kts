...
dependencies {
  ...
  implementation("com.google.apis:google-api-services-drive:v3-rev20260913-2.0.0")
  implementation("com.opencsv:opencsv:5.12.0")
  implementation("com.pgvector:pgvector:0.1.6")
  implementation("com.squarespace.cldr-engine:cldr-engine:1.16.0")
  ...
  implementation("org.jobrunr:jobrunr-spring-boot-3-starter:8.8.2")

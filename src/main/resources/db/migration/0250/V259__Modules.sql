...
ALTER TABLE accelerator.modules ADD COLUMN private_session_description TEXT;
ALTER TABLE accelerator.modules ADD COLUMN additional_resources TEXT;

ALTER TABLE accelerator.cohort_modules ADD COLUMN phase_id INTEGER REFERENCES accelerator.cohort_phases;
UPDATE accelerator.cohort_modules SET phase_id = 1 WHERE phase_id IS NULL;
ALTER TABLE accelerator.cohort_modules ALTER COLUMN phase_id SET NOT NULL;

CREATE TABLE tracking.observation_biomass_herbaceous_species (
...
CREATE INDEX ON tracking.observation_biomass_herbaceous_species(monitoring_plot_id);

CREATE TABLE tracking.observation_biomass_tree_species (
     observation_id BIGINT NOT NULL REFERENCES tracking.observations ON DELETE CASCADE,
     monitoring_plot_id BIGINT NOT NULL REFERENCES tracking.monitoring_plots ON DELETE CASCADE,
     species_id BIGINT REFERENCES species,
     scientific_name TEXT,
...
CREATE INDEX ON tracking.observation_biomass_tree_species(monitoring_plot_id);

...
UPDATE accelerator.participant_project_species SET created_by = (SELECT id FROM users WHERE user_type_id = 4);
UPDATE accelerator.participant_project_species SET modified_by = (SELECT id FROM users WHERE user_type_id = 4);

...
CREATE INDEX ON accelerator.project_report_configs(project_id);
...
CREATE INDEX ON accelerator.reports(project_id);
CREATE INDEX ON accelerator.reports(end_date);

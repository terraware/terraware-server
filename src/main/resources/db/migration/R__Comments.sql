...
COMMENT ON TABLE ecoregions IS 'WWF/Resolve ecoregion definitions.';
COMMENT ON COLUMN ecoregions.id IS 'Numeric identifier of each ecoregion. This comes from the WWF/Resolve data; it is not auto-generated by the database.';

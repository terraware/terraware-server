...
sealed interface PlantingSeasonScheduledDateSpeciesPersistentEvent : PersistentEvent {
...
data class PlantingSeasonScheduledDateSpeciesCreatedEventV1(
...
) : EntityCreatedPersistentEvent, PlantingSeasonScheduledDateSpeciesPersistentEvent

typealias PlantingSeasonScheduledDateSpeciesCreatedEvent =
    PlantingSeasonScheduledDateSpeciesCreatedEventV1

data class PlantingSeasonScheduledDateSpeciesDeletedEventV1(
    override val organizationId: OrganizationId,
    override val plantingSeasonId: PlantingSeasonId,
    override val plantingSiteId: PlantingSiteId,
    override val scheduledPlantingDateId: ScheduledPlantingDateId,
    ...
    override val substratumId: SubstratumId,
    override val substratumName: String,
) : EntityDeletedPersistentEvent, PlantingSeasonScheduledDateSpeciesPersistentEvent

typealias PlantingSeasonScheduledDateSpeciesDeletedEvent =
    PlantingSeasonScheduledDateSpeciesDeletedEventV1

data class PlantingSeasonScheduledDateSpeciesUpdatedEventV1(
    ...
    override val substratumId: SubstratumId,
    override val substratumName: String,
) : FieldsUpdatedPersistentEvent, PlantingSeasonScheduledDateSpeciesPersistentEvent {
...
typealias PlantingSeasonScheduledDateSpeciesUpdatedEvent =
    PlantingSeasonScheduledDateSpeciesUpdatedEventV1

typealias PlantingSeasonScheduledDateSpeciesUpdatedEventValues =
    PlantingSeasonScheduledDateSpeciesUpdatedEventV1.Values

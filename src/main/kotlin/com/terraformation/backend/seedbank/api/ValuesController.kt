...
class ValuesController(
  ...
  private val rootPrefix = SearchFieldPrefix(root = tables.accessions)
...
data class SeedbankValuesPayload(
    @ArraySchema(
...
data class ListFieldValuesResponsePayload(val results: Map<String, SeedbankValuesPayload>) :

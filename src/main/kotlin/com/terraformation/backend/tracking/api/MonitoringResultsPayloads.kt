...
data class ObservationResultsPayload(
    ...
    val survivalRate: Int?,
    val survivalRateCalculationInProgress: Boolean,
    val survivalRateStdDev: Int?,
    val totalPlants: Int?,
    val totalSpecies: Int?,
  ...
  constructor(
      ...
      state = model.state,
      strata = model.strata.map { ObservationStratumResultsPayload(it) },
      survivalRate = model.survivalRate,
      survivalRateCalculationInProgress = model.survivalRateCalculationInProgress,
      survivalRateStdDev = model.survivalRateStdDev,
      totalPlants = model.totalPlants,
      totalSpecies = model.totalSpecies,

...
class AcceleratorReportCommonIndicatorsTable(tables: SearchTables) : SearchTable() {
  override val primaryKey: TableField<out Record, out Any?>
    get() = REPORT_COMMON_INDICATORS.REPORT_COMMON_INDICATOR_ID
   ...
   */
  private val indicatorsForOrder = COMMON_INDICATORS.`as`("common_indicators_for_order")

  override val fromTable
    get() =
        REPORT_COMMON_INDICATORS.join(indicatorsForOrder)
            .on(REPORT_COMMON_INDICATORS.COMMON_INDICATOR_ID.eq(indicatorsForOrder.ID))
  ...
  override val fields: List<SearchField> =
      listOf(
          idWrapperField("id", REPORT_COMMON_INDICATORS.COMMON_INDICATOR_ID) {
            CommonIndicatorId(it)
          },
  ...
  override val defaultOrderFields: List<OrderField<*>>
    get() =
        listOf(indicatorsForOrder.REF_ID, indicatorsForOrder.ID, REPORT_COMMON_INDICATORS.REPORT_ID)

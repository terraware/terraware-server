...
class SearchTables(clock: Clock) {
  val acceleratorReportAutoCalculatedIndicators =
      AcceleratorReportAutoCalculatedIndicatorsTable(this)
  val acceleratorReportCommonIndicators = AcceleratorReportCommonIndicatorsTable(this)
  val acceleratorReportProjectIndicators = AcceleratorReportProjectIndicatorsTable(this)
  ...
  val autoCalculatedIndicators = AutoCalculatedIndicatorsTable(this)
  val batchWithdrawals = BatchWithdrawalsTable(this)
  val botanicalCountries = BotanicalCountriesTable(this)
  val commonIndicators = CommonIndicatorsTable(this)
  ...
  val mediaFiles = MediaFilesTable(this)
  ...
  val nurseryWithdrawalPhotos = NurseryWithdrawalPhotosTable(this)
  ...
  val observationPlotResult = ObservationPlotResultTable(this)
  val observationPlots = ObservationPlotsTable(this)
  val observations = ObservationsTable(this)
  val observationSiteResult = ObservationSiteResultTable(this)
  val observationStratumResult = ObservationStratumResultTable(this)
  val observationSubstratumResult = ObservationSubstratumResultTable(this)
  ...
  val plantingDateRequests = PlantingDateRequestsTable(this)
  val plantingDateRequestSpecies = PlantingDateRequestSpeciesTable(this)
  ...
  val plantingSiteSpeciesTargets = PlantingSiteSpeciesTargetsTable(this)
  ...
  val projectIndicators = ProjectIndicatorsTable(this)
  ...
  val projectSpecies = ProjectSpeciesTable(this)
  ...
  val scheduledPlantingDateSpeciesTable = ScheduledPlantingDateSpeciesTable(this)
  val seedFundReports = SeedFundReportsTable(this)
  ...
  val strata = StrataTable(this)
  val stratumHistories = StratumHistoriesTable(this)
  val stratumPopulations = StratumPopulationsTable(this)
  val stratumSpeciesTargets = StratumSpeciesTargetsTable(this)
  val subLocations = SubLocationsTable(this)
  val substrata = SubstrataTable(this)
  val substratumHistories = SubstratumHistoriesTable(this)
  val substratumPopulations = SubstratumPopulationsTable(this)

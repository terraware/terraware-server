...
class NurseryWithdrawalsTable(private val tables: SearchTables) : SearchTable() {
  ...
  override val fields: List<SearchField> =
      listOf(
          ...
          textField("plantingSubzoneNames", WITHDRAWAL_SUMMARIES.SUBSTRATUM_FULL_NAMES),
          enumField("purpose", WITHDRAWAL_SUMMARIES.PURPOSE_ID),
          textField("stratumNames", WITHDRAWAL_SUMMARIES.STRATUM_NAMES),
          textField("substratumNames", WITHDRAWAL_SUMMARIES.SUBSTRATUM_FULL_NAMES),
          textField("substratumShortNames", WITHDRAWAL_SUMMARIES.SUBSTRATUM_NAMES),

 ...
 * always represents an individual or funder; device managers are represented by
 * [DeviceManagerUser].
 *
...
abstract class OrdinaryUser(
    ...
    open val emailNotificationsEnabled: Boolean = true,
    open val firstName: String? = null,
    open val lastName: String? = null,
    open val countryCode: String? = null,
    open val cookiesConsented: Boolean? = null,
    open val cookiesConsentedTime: Instant? = null,
    override val locale: Locale? = null,
    override val timeZone: ZoneId? = null,
    override val userType: UserType,
    protected open val parentStore: ParentStore,
    protected open val permissionStore: PermissionStore,
) : TerrawareUser, UserDetails {
  companion object {
    @JvmStatic protected val log = perClassLogger()
  ...
  protected fun recordPermissionCheck(check: PermissionCheck) {

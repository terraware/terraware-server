...
class ApplicationsController {
  ...
  @InternalEndpoint
  @Operation(
      summary = "Update an application's metadata",
  ...
  fun updateApplication(
      @PathVariable applicationId: ApplicationId,
      @RequestBody payload: UpdateApplicationRequestPayload
...
data class UpdateApplicationRequestPayload(
    val feedback: String?,
    val internalComment: String?,
    val status: ApplicationStatus,
)

data class UpdateApplicationBoundaryRequestPayload(val boundary: Geometry)

data class CreateApplicationResponsePayload(
    val id: ApplicationId,

...
class EmailService(
  ...
  /**
   * Sends an alert about a facility. These alerts are typically generated by the device manager.
   */
  @EventListener
  fun on(event: FacilityAlertRequestedEvent) {
    ...
    sendFacilityNotification(event.facilityId, "facilityAlert", model)
  }
  ...
  fun on(event: FacilityIdleEvent) {
    ...
    sendFacilityNotification(facility.id, "facilityIdle", model)
  }
  ...
  fun on(event: UserAddedToOrganizationEvent) {
    ...
    sendUserNotification(user, "userAddedToOrganization", model, requireOptIn = false)
  }
  ...
  private fun sendFacilityNotification(

...
// Column 15/O
const val VARIABLE_CSV_COLUMN_INDEX_DELIVERABLE_QUESTION = VARIABLE_CSV_COLUMN_INDEX_DELIVERABLE_ID + 1
// Column 16/P
const val VARIABLE_CSV_COLUMN_INDEX_DEPENDENCY_VARIABLE_ID = VARIABLE_CSV_COLUMN_INDEX_DELIVERABLE_QUESTION + 1
// Column 17/Q
const val VARIABLE_CSV_COLUMN_INDEX_DEPENDENCY_CONDITION = VARIABLE_CSV_COLUMN_INDEX_DEPENDENCY_VARIABLE_ID + 1
// Column 18/R
const val VARIABLE_CSV_COLUMN_INDEX_DEPENDENCY_VALUE = VARIABLE_CSV_COLUMN_INDEX_DEPENDENCY_CONDITION + 1
// Column 19/S

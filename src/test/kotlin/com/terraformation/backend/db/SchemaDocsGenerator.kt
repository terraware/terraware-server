      ...
      mapOf(
          "accelerator" to
              mapOf(
                  ...
                  "report_standard_indicator_targets" to setOf(ALL, ACCELERATOR),
                  "report_standard_indicators" to setOf(ALL, ACCELERATOR),
                  "report_statuses" to setOf(ALL, ACCELERATOR),
                  "reports" to setOf(ALL, ACCELERATOR),
                  "score_categories" to setOf(ALL, ACCELERATOR),
                  "standard_indicators" to setOf(ALL, ACCELERATOR),
          ...
          "funder" to
              mapOf(
                  ...
                  "published_report_standard_indicators" to setOf(ALL, FUNDER),
                  "published_reports" to setOf(ALL, FUNDER),
                  "published_standard_indicator_targets" to setOf(ALL, FUNDER),
              ),
          "nursery" to
              mapOf(

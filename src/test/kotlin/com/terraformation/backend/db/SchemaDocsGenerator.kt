      ...
      mapOf(
          "accelerator" to
              mapOf(
                  ...
                  "project_project_metric_targets" to setOf(ALL, ACCELERATOR),
                  "project_report_configs" to setOf(ALL, ACCELERATOR),
                  "project_scores" to setOf(ALL, ACCELERATOR),
                  "project_standard_metric_targets" to setOf(ALL, ACCELERATOR),
                  "project_system_metric_targets" to setOf(ALL, ACCELERATOR),

      ...
      mapOf(
          "accelerator" to
              mapOf(
                  ...
                  "activity_observations" to setOf(ALL, ACCELERATOR),
                  ...
                  "auto_calculated_indicator_targets" to setOf(ALL, ACCELERATOR),
                  "auto_calculated_indicators" to setOf(ALL, ACCELERATOR),
                  "common_indicator_targets" to setOf(ALL, ACCELERATOR),
                  "common_indicators" to setOf(ALL, ACCELERATOR),
                  ...
                  "project_indicator_targets" to setOf(ALL, ACCELERATOR),
                  "project_indicators" to setOf(ALL, ACCELERATOR),
                  ...
                  "report_common_indicator_targets" to setOf(ALL, ACCELERATOR),
                  "report_common_indicators" to setOf(ALL, ACCELERATOR),
          ...
          "funder" to
              mapOf(
                  ...
                  "published_common_indicator_baselines" to setOf(ALL, FUNDER),
                  "published_common_indicator_targets" to setOf(ALL, FUNDER),
                  "published_project_carbon_certs" to setOf(ALL, FUNDER),
                  "published_project_indicator_baselines" to setOf(ALL, FUNDER),
                  "published_project_land_use" to setOf(ALL, FUNDER),
                  "published_project_indicator_targets" to setOf(ALL, FUNDER),
                  ...
                  "published_report_auto_calculated_indicators" to setOf(ALL, FUNDER),
                  "published_report_challenges" to setOf(ALL, FUNDER),
                  "published_report_common_indicators" to setOf(ALL, FUNDER),
                  "published_report_photos" to setOf(ALL, FUNDER),
                  "published_report_project_indicators" to setOf(ALL, FUNDER),
          ...
          "public" to
              mapOf(
                  ...
                  "botanical_countries" to setOf(ALL, SPECIES),
                  ...
                  "project_species" to setOf(ALL, SPECIES),
                  ...
                  "species_nativities" to setOf(ALL, SPECIES),
                  ...
                  "splat_additional_file_types" to setOf(ALL),
                  "splat_additional_files" to setOf(ALL),
          ...
          "tracking" to
              mapOf(
                  ...
                  "observation_plot_results" to setOf(ALL, TRACKING),
                  "observation_plot_statuses" to setOf(ALL, TRACKING),
                  "observation_plots" to setOf(ALL, TRACKING),
                  "observation_requested_substrata" to setOf(ALL, TRACKING),
                  "observation_site_results" to setOf(ALL, TRACKING),
                  "observation_states" to setOf(ALL, TRACKING),
                  "observation_stratum_results" to setOf(ALL, TRACKING),
                  "observation_substratum_results" to setOf(ALL, TRACKING),
                  ...
                  "planting_date_request_species" to setOf(ALL, TRACKING),
                  "planting_date_request_statuses" to setOf(ALL, TRACKING),
                  "planting_date_requests" to setOf(ALL, TRACKING),
                  "planting_season_allocated_species" to setOf(ALL, TRACKING),
                  "planting_season_notification_pages" to setOf(ALL, TRACKING),
                  "planting_season_notifications" to setOf(ALL, TRACKING),
                  ...
                  "simplified_strata" to setOf(ALL, TRACKING),
                  ...
                  "stratum_species_targets" to setOf(ALL, TRACKING),
                  "stratum_t0_temp_densities" to setOf(ALL, TRACKING),
                  "substrata" to setOf(ALL, TRACKING),
                  "substratum_histories" to setOf(ALL, TRACKING),
                  "substratum_populations" to setOf(ALL, TRACKING),

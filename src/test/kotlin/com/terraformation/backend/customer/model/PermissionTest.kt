...
internal class PermissionTest : DatabaseTest() {
  ...
  inner class PermissionsTracker {
    ...
    fun expect(
        ...
        createPlantingSeason: Boolean = false,
      ...
      plantingSiteIds.forEach { plantingSiteId ->
        ...
        assertEquals(
            ...
            user.canCreatePlantingSeason(idInDatabase),
            "Can create planting season at planting site $plantingSiteId",
        )
        assertEquals(
            deletePlantingSite,
    ...
    fun expect(
        ...
        readProjectIndicators: Boolean = false,
      ...
      projectIds.forEach { projectId ->
        ...
        assertEquals(
            readProjectIndicators,
            user.canReadProjectIndicators(idInDatabase),
            "Can read indicators for project $projectId",
        )
        assertEquals(
            readProjectReports,
